...
public class Donnation implements Serializable {
	...
	public Donnation(int id, Event event, User user, String contributionDate, float amount) {
		super();
		this.id = id;
		this.event = event;
		this.user = user;
	...
	public Donnation(Event event, User user, String contributionDate, float amount) {
		super();
		this.event = event;
		this.user = user;
		this.contributionDate = contributionDate;
	...
	public String toString() {
		return "Donnation [id=" + id + ", event=" + event + ", user=" + user + ", contributionDate=" + contributionDate
				+ ", amount=" + amount + "]";
	}
	@Override
	public int hashCode() {
